		...
		<div align="center" id="searchTable" >
			<form action="studioFind_Second.php" method="post" id="actorTableButton">
				<div class="display: inline;">
					工作室名子:
					<input placeholder="請輸入工作室名子" name="studio_att1" style = "width:150px;height:20px" value = '<?php echo $_POST["studio_att1"] ?>'>
					發表的電影:
					<input placeholder="請輸入發表的電影" name="studio_att2" style = "width:150px;height:20px" value = '<?php echo $_POST["studio_att2"] ?>'>
					導演:
					<input placeholder="請輸入導演名子" name="studio_att3" style = "width:150px;height:20px" value = '<?php echo $_POST["studio_att3"] ?>'>
				</div>
				<br></br>
				<input type="submit">
			</form>
