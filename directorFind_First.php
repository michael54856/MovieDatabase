		...
		<div align="center" id="searchTable" >
			<form action="directorFind_Second.php" method="post" id="actorTableButton">
				<div class="display: inline;">
					導演名子:
					<input placeholder="請輸入導演名子" name="director_att1" style = "width:150px;height:20px">
					執導的電影:
					<input placeholder="請輸入執導過的電影" name="director_att2" style = "width:150px;height:20px">
					性別:
					...
					所屬工作室:
					<input placeholder="請輸入所屬工作室" name="director_att4" style = "width:150px;height:20px">
				</div>
				<br></br>
				<input type="submit">
			</form>
