		...
		<div align="center" id="searchTable" >
			<form action="actorFind_Second.php" method="post" id="actorTableButton">
				<div class="display: inline;">
					演員名子:
					<input placeholder="請輸入演員名子" name="actor_att1" style = "width:150px;height:20px">
					演過的電影:
					<input placeholder="請輸入演過的電影" name="actor_att2" style = "width:150px;height:20px" >
					性別:
					...
					國籍:
					<input placeholder="請輸入演員國籍" name="actor_att4" style = "width:150px;height:20px" >
				</div>
				<br></br>
				<input type="submit">
			</form>
